...
abstract class DessertItem
    ...
    class Candy extends DessertItem
    {
        ...
        {
            cost=cost+tax;
            out.println("cost of cookie is "+cost+ "along with the tax "+tax);
        }
        void addItem(int number,int addnumber)
        {
            out.println("available candies are"+number+"candy's added"+addnumber);
        }
    }
    class Cookie extends DessertItem
    {
        ...
        void addItem(int number,int addnumber)
        {
            ...
            out.println("available cookies are"+number+"cookie's added"+addnumber);
        }
    ...
    class IceCream extends DessertItem
    {
        ...
        {
            cost=cost+tax;
            out.println("cost of icecream is "+cost+ "along with the tax "+tax);
        }
        void addItem(int number,int addnumber)
        {

            out.println("available icecreams are"+number+"icecreams's added"+addnumber);
        }
    }
    class Owner
    {
